...
class MyAccountView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => MyAccountCubit()..importData(profileModel),
                    ...
                    child: Column(
                      children: [
                        ...
                        CustomTextField(
                          ...
                          controller:
                              MyAccountCubit.get(context).nameController,
                        ),
                        CustomTextField(
                          title: S.of(context).email,
                          icon: FontAwesomeIcons.envelope,
                          controller:
                              MyAccountCubit.get(context).emailController,
                        ),
                        CustomTextField(
                          title: S.of(context).phone,
                          icon: FontAwesomeIcons.phone,
                          controller:
                              MyAccountCubit.get(context).phoneController,
                        ),
                        CustomTextField(
